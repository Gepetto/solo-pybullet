...
def c(q, qdot, dt):
    # unactuated, [x, y, z] position of the base
    # + [x, y, z, w] orientation of the base (stored as a quaternion)
    # qu = q[:7]
    # actuated, [q1, q2, ..., q8] angular position of the 8 motors
    qa = q[7:]
    # [v_x, v_y, v_z] linear velocity of the base
    # and [w_x, w_y, w_z] angular velocity of the base along x, y, z axes
    # of the world
    # qu_dot = qdot[:6]
    ...
    # torques must be a numpy array of shape (8, 1)
    # containing the torques applied to the 8 motors
    return torques
...
def c_walking_IK(q, qdot, dt, solo, t_simu):
    ...
    # Take only the translation terms
    fJ_FL3 = pin.frameJacobian(solo.model, solo.data, q_ref, ID_FL)[:3, -8:]
...
def c_walking_ID(q, qdot, dt, solo, t_simu):
    ...
    qa = q[7:]  # actuated, [q1, q2, ..., q8] angular position of the 8 motors
    # [v_x, v_y, v_z] linear velocity of the base
    # and [w_x, w_y, w_z] angular velocity of the base along x, y, z axes of the world
    # qu_dot = qdot[:6]
    qa_dot = qdot[6:]  # angular velocity of the 8 motors
    ...
    err_HL = xz_HL - xzdes_HL
    err_HR = xz_HR - xzdes_HR
    print(err_FL, err_FR, err_HL, err_HR)
